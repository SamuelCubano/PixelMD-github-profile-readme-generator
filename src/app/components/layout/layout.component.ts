  ...
  template: `
    ...
    <div class="repo-banner">
      <div class="banner-content">
        ...
        <span>¿Te gusta PixelMD? <a href="https://github.com/SamuelCubano/PixelMD-github-profile-readme-generator" target="_blank">Apóyanos con una estrella en GitHub</a></span>
      </div>
    </div>
  `,
})
